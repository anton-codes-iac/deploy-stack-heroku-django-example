...
resource "aws_cloudwatch_log_group" "app_logs" {
  name              = "/ecs/deploy-stack-heroku-django-example"
  retention_in_days = 14
}

# --- ECR Repository ---
resource "aws_ecr_repository" "app" {
  name                 = "deploy-stack-heroku-django-example-repo"
...
resource "aws_iam_role" "execution_role" {
  name               = "deploy-stack-heroku-django-example-execution-role"
...
resource "aws_iam_role" "task_role" {
  name               = "deploy-stack-heroku-django-example-task-role"
  assume_role_policy = data.aws_iam_policy_document.ecs_trust.json
}

# --- ECS Cluster ---
resource "aws_ecs_cluster" "main" {
  name = "deploy-stack-heroku-django-example-cluster"
}

# --- ECS Task Definition ---
resource "aws_ecs_task_definition" "app" {
  family                   = "deploy-stack-heroku-django-example-task"
  network_mode             = "awsvpc"
  ...
  container_definitions = jsonencode([
    {
      name      = "deploy-stack-heroku-django-example-container"
      ...
      command = ["gunicorn","core.wsgi","-b","0.0.0.0:8000","--access-logfile","-","--log-file","-"]
...
resource "aws_lb" "main" {
  name               = "deploy-stack-heroku-django-alb"
...
resource "aws_ecs_service" "app" {
  name            = "deploy-stack-heroku-django-example-service"
...
resource "aws_iam_role_policy" "secrets_policy" {
  name   = "deploy-stack-heroku-django-example-secrets-policy"
...
resource "aws_cloudwatch_metric_alarm" "alb_5xx_errors" {
  alarm_name          = "deploy-stack-heroku-django-example-high-5xx-errors"
