...
resource "aws_vpc" "main" {
  ...
  tags = {
    Name = "deploy-stack-heroku-django-example-vpc"
  }
}
...
resource "aws_subnet" "public" {
  ...
  tags = {
    Name = "deploy-stack-heroku-django-example-public-subnet-${count.index + 1}"
  }
}
...
resource "aws_security_group" "alb" {
  name        = "deploy-stack-heroku-django-example-alb-sg"
...
resource "aws_security_group" "ecs_tasks" {
  name        = "deploy-stack-heroku-django-example-ecs-sg"
